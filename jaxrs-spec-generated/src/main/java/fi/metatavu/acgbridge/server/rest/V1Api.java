...
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2017-08-02T09:25:31.534+03:00")
...
public abstract class V1Api extends AbstractApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 204, message = "The transaction were canceled successfully.", response = void.class),
    ...
    public abstract Response cancelTransaction(@PathParam("transactionId") String transactionId,@Context Request request);
    ...
    @Consumes({ "application/json;charset=utf-8" })
    @Produces({ "application/json;charset=utf-8" })
    @ApiOperation(value = "Updates transaction", notes = "Updates transaction", response = void.class, tags={ "Transactions" })
    @ApiResponses(value = { 
        @ApiResponse(code = 204, message = "The transaction were canceled successfully.", response = void.class),
        @ApiResponse(code = 400, message = "Invalid request was sent to the server", response = void.class),
        @ApiResponse(code = 403, message = "Attempted to make a call with unauthorized client", response = void.class),
        @ApiResponse(code = 500, message = "Internal server error", response = void.class) })
    public abstract Response updateTransaction(@PathParam("transactionId") String transactionId,Transaction body,@Context Request request);
